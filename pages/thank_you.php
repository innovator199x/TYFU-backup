          ...
          <div class="col-xl-12 xl-100 col-lg-12 box-col-12">
                <div class="card">
                  <div class="card-header">
                    <h5 class="pull-left">Manage Thank You Follow-Up</h5>
                  </div>
                  <div class="card-body">
                      ...
                      <div class="tab-content" id="pills-clrtabContentinfo">
                        <div class="tab-pane fade show active" id="pills-clrhomeinfo" role="tabpanel" aria-labelledby="pills-clrhome-tabinfo">
                            ...
                            <div class="mb-3">
                                ...
                                <button id="prev_email" class="btn btn-primary" type="button" style=""><i class="fa fa-envelope-o"></i>Choose Template</button>
                            </div>
