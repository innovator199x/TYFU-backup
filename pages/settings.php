        ...
        if(isset($_POST['submit'])) {
          ...
          $description = $_POST['business_desc'];
          $timezone = $_POST['timezone'];
          // $sms = $_POST['feature'];
          $email_notify = $_POST['email_notify'];
          $domain_name = str_replace("'", "", $_POST['domain_names']);
          $noti = '0';
          if(isset($_POST['is_notify']))
          {
              $noti = '1';
          }
          ...
          $domain_name =  str_replace(' ', '-', strtolower($_POST['domain_names']));
          
          // $domain = false;
          
          // $dom_check = create_subdomain($domain_name);
          
          // $Email_check = create_Email($business_name,$domain_name);
          
          // if($dom_check==1)
          // {
          //     $rows['domain_name'] =  $domain_name;
          //     $rows["domain_created"]= true;
          ...
          // if($dom_check==1 || $dom_check==2)
          // {
              $rows['business_from_email'] =  "customerservice@$domain_name.thankyoufollowup.com";
          ...
          if ($res) {
              ...
              echo "<script>location.href='settings?msg=update'</script>";
              //  echo "<script>location.href='dashboard.php?msg=update'</script>";
          } else {
              // echo mysqli_error();
            ...
            <form method="POST" action="" method="post" enctype="multipart/form-data" name="form1">
              <div class="card">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="mb-3">
                        ...
                        <input class="form-control" id="name" name="name" type="text" placeholder="Enter name" value="<?=$data['name']?>">
                      </div>
                      <div class="mb-3">
                        <label class="col-form-label pt-0">Business Name</label>
                        <input class="form-control" id="business_name" name="business_name" type="text" placeholder="Business Name" value="<?=$data['business_name']?>">
                      </div>
                      <div class="mb-3">
                        <label class="col-form-label pt-0">Select Timezone </label>
                        <select name="timezone" class="form-control border_s">
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" name="business_logo" id="business_logo" type="file" accept="image/*">
                      </div>
                      <div class="mb-3">
                        <div class="form-group">
                            <label class="control-label" for="email">Business  Logo:</label>
                            <input type="hidden" name="logo" value="<?php echo $data['logo']; ?>">
                            <img src="../assets/images/business_logo/<?php echo $data['logo']; ?>" alt="Business logo" height="auto" width="150px">
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="mb-3">
                        ...
                        <input class="form-control" id="mobile_number" name="mobile_number" type="text" placeholder="Mobile Number" value="<?=$data['mobile_no']?>">
                      </div>
                     
                      <div class="mb-3">
                        <label class="col-form-label pt-0">Your Domain</label>
                        <div class="input-group">
                          <input class="form-control" id="domain_names" name="domain_names" type="text" placeholder="Your Domain" value="<?=$data['domain_name']?>"><span class="input-group-text">.thankyoufollowup.com</span>
                        </div>
                      </div>
                      <div class="mb-3">
                        <label class="col-form-label pt-0">Business Email</label>
                        <input class="form-control" id="business_email" name="business_email" type="text" placeholder="Business Email" value="<?=$data['business_email']?>">
                      </div>
                      <div class="mb-3">
                        <label class="col-form-label pt-0">Business Description</label>
                        <textarea id="business_desc" name="business_desc" class="form-control" placeholder="Business Description"><?=$data['description']?></textarea>
                      </div>
                ...
                <div class="card-footer text-end">
                  <button type="submit" name="submit" class="btn btn-success" value="business_settings">Save Changes</button>
                </div>
              </div>
              </form>
            </div>
